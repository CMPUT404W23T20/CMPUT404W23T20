...
import { Box, Button, Card, Divider, List, ListItem, TextField, Typography, MenuItem, InputLabel, ListItemText } from '@material-ui/core';
        ...
        <Box>
            <Box className="App" style={{ display: "flex", flexDirection: "row", height: "100vh", width: "100vw", alignItems: "left", justifyContent: "left" }}>
                ...
                <Box style={{ display: "flex", flexDirection: "row", backgroundColor: "white", flex: 1, height: "100vh" }}>
                    ...
                    >
                        <Box style={{ display: "flex", flexDirection: "column", flex: 1, margin: "10px", padding: "20px" }}>
                                ...
                                {loadingFollowing &&
                                    followingPosts.map((post) => (
                                        <ListItem key={post.id} onClick={() => { setopenPost(true); setPost(post); }}>
                                            <Card style={{ width: "100%", display: "flex", flexDirection: "row", alignItems: "center", margin: "10px 0", padding: "10px" }}>
                                                <Box style={{ display: "flex", flexDirection: "column", flex: 1, paddingLeft: "10px" }}>
                                                    ...
                                                    <Box style={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
                                                        <img
                                                            ...
                                                            alt="Author's profile" style={{ borderRadius: "50%", marginRight: "10px" }} width="40px" height="40px"
                                                        />
                                                        <Box>
                                                            <Typography variant="body1">{post.author.displayName}</Typography>
                                    ...
                                    <ListItem key={post.id} onClick={() => { setopenPost(true); setPost(post) }}>
                                        <Card style={{ width: "100%", display: "flex", flexDirection: "row", alignItems: "center", margin: "10px 0", padding: "10px" }}>
                                            <Box style={{ display: "flex", flexDirection: "column", flex: 1, paddingLeft: "10px" }}>
                                                ...
                                                <Divider style={{ margin: "5px 0" }} />
                                                <Box style={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
                                                    <img src={(post.author.profileImage != "no profileImage" && post.author.profileImage != "") ? post.author.profileImage : "https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/Solid_white.svg/2048px-Solid_white.svg.png"} alt="Author's profile" style={{ borderRadius: "50%", marginRight: "10px" }} width="40px" height="40px" />
                                                    <Box>
                                                        <Typography variant="body1">{post.author.displayName}</Typography>
                                                        <Typography variant="body2">Published: {post.published.substring(0, 10)}</Typography>
                                                        <Typography variant="body2">Node: {post.author.host}</Typography>
                        ...
                        <Box style={{
                            ...
                            <Box style={{
                                ...
                                <Box style={{
                                    ...
                                    <img src={(post.author.profileImage != "no profileImage" && post.author.profileImage != "") ? post.author.profileImage : "https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/Solid_white.svg/2048px-Solid_white.svg.png"} alt="IMG" style={{
                                        borderRadius: "50%",
                                        marginRight: "10px"
                            ...
                            <Box style={{ padding: "10px" }}>
                                ...
                                <Typography variant="body1" style={{ marginTop: "10px" }}>{post.description}</Typography>
                                {post.image_data ? (
                                    <Box style={{
                                        margin: "10px 0",
                                        display: "flex",
                                        ...
                                        <img src={`data:image/png;base64,${post.image_data}`} alt="Post Image" style={{
                                            maxWidth: "100%",
                                            maxHeight: "300px"
                                        }} />
                                    </Box>
