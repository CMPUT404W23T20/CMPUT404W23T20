...
urlpatterns = [
    ...
    path('api/<str:author_id>/friendrequest/<int:fk>',views.FriendRequestViewSet.as_view(),name='friendReq'),
    path('api/authors/<str:author_id>/followers/<int:fk>',views.FollowersViewSet.as_view(),name='followers'),
    path('api/authors/<str:author_id>/followers/',views.FollowersViewSet.as_view(),name='followers'),  
